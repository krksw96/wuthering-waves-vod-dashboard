...
const videosSource = await readFile("data/zenless-zone-zero.js", "utf8");
...
const refreshedHtml = html.replace(/data\/zenless-zone-zero\.js\?v=[^"]+/, `data/zenless-zone-zero.js?v=refresh-${compactEnd}-${total}`);
